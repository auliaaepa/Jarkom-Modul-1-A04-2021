...
## Soal 2
Temukan paket dari web-web yang menggunakan _basic authentication method_! 
...
Untuk mendapatkan pasword dan username yang didapat dari query insert  pada table users yaitu dengan cara memasukan kode ```mysql.command ==3 and frame matches "insert"```
...
## Soal 8
Cari paket yang menunjukan pengunggahan file ke FTP tersebut!
...
## Kendala
Adapun kendala yang kami alami dalam pengerjaan ini adalah kesulitan untuk menemukan filter-filter yang tepat pada beberapa soal yang diberikan.
